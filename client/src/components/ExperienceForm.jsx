                ...
                {data.map((experience, index) => (
                    <div key={index} className='p-4 border border-gray-200 rounded-lg space-y-3'>
                        ...
                        <div className='grid md:grid-cols-2 gap-3'>
                            <input type="text" placeholder='Company Name' className='px-2 py-2 text-sm rounded-lg' value={experience.company || ""} onChange={(e)=>updatedExperience(index, "company", e.target.value)} />
                            <input type="text" placeholder='Job title' className='px-2 py-2 text-sm rounded-lg' value={experience.position || ""} onChange={(e)=>updatedExperience(index, "position", e.target.value)} />
                            <input type="month" className='px-2 py-2 text-sm rounded-lg' value={experience.start_date || ""} onChange={(e)=>updatedExperience(index, "start_date", e.target.value)} />
                            <input type="month" className='px-2 py-2 text-sm rounded-lg disabled:bg-gray-100' value={experience.end_date || ""} onChange={(e)=>updatedExperience(index, "end_date", e.target.value)} disabled={experience.is_current} />
                        </div>
                        ...
                        <div className='space-y-2'>
                            ...
                            <textarea value={experience.description || ""} onChange={(e)=> updatedExperience(index, "description", e.target.value)} rows={4} name="" id="" className='w-full text-sm px-3 py-2 rounded-lg resize-none' placeholder='Describe your key responsibilities and achievements...'/>
                        </div>
                    </div>
                ))}
            </div>
